...
export function ContentEditorView({
  ...
  return (
    <div className='w-full max-w-5xl'>
      ...
      {/* Editor Area */}
      <div className='bg-surface-secondary/30 rounded-2xl border border-border shadow-sm p-6 sm:p-8 min-h-150 flex flex-col'>
        {isEditing && (
          <div className='mb-6 flex flex-wrap items-center gap-2 rounded-lg bg-[#1a1d21] p-2 text-text-muted shadow-sm w-fit'>
            ...
            <button className='px-2 py-1 hover:text-white hover:bg-white/10 rounded font-bold'>
              B
            </button>
            <button className='px-2 py-1 hover:text-white hover:bg-white/10 rounded italic'>
              I
            </button>
            <button className='px-2 py-1 hover:text-white hover:bg-white/10 rounded underline'>
              U
            </button>
            <button className='px-2 py-1 hover:text-white hover:bg-white/10 rounded line-through'>
              S
            </button>
            <div className='w-px h-4 bg-gray-600 mx-1'></div>
        ...
        <div className='flex-1'>
          {isEditing ? (
            <textarea
              ...
              className='w-full h-full min-h-100 resize-none bg-transparent text-text-secondary leading-relaxed focus:outline-none'
            />
          ) : (
